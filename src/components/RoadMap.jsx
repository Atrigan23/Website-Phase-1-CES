...
const Roadmap = () => {
    ...
    return (
        <div className="relative flex sm: flex-col items-center max-container mb-24">
            <h2 className="font-bold mt-10 items-center font-palanquin text-4xl capitalize lg:max-w-lg">
                <span className="text-blue-700 drop-shadow font-bold">Client</span> Onboarding
            </h2>
            ...
            <div className="relative flex justify-between items-center w-4/5 h-1 bg-gray-300 mb-20">
                {points.map((point, index) => (
                    ...
                    >
                        ...
                        {hoveredPoint === point.id && (
                            <div className="absolute top-32 transform-translate-x-1/2 bg-white p-4 rounded shadow-lg w-[300px] text-center transition-opacity duration-300 opacity-100">
